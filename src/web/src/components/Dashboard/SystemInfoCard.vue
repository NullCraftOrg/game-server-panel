                ...
                <div class="join-item">
                    <div class="flex gap-2">
                        <div>
                            <button class="btn btn-square">
                                <!-- Windows 图标-->
                                <svg v-if="systemInfo?.os.platform === 'win32'" class="size-5.5"
                                ...
                                <!-- Linux 图标-->
                                <svg v-else-if="systemInfo?.os.platform === 'linux'" xmlns="http://www.w3.org/2000/svg"
                        ...
                        <div>
                            <div>{{ systemInfo?.os.type ?? '-' }}{{ systemInfo?.os.release ? `
                                (${systemInfo?.os.release})` : '' }}</div>
